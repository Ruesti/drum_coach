...
const rudimentsSeedData = <Rudiment>[
  ...
  Rudiment(
    ...
    skill: [Skill.koordination, Skill.kontrolle],
  ...
  Rudiment(
    id: 'linear_beat_1',
    name: 'Linear Beat 1',
    skill: [Skill.koordination, Skill.independence],
    description:
  ...
  Rudiment(
    ...
    skill: [Skill.ausdauer, Skill.kontrolle],
